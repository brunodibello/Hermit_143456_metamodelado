...
public class MetamodellingTests extends TestCase {
	...
	public void testDifference6() {
		...
		flags.add(testCasesPath+"Equal/TestDifference6.owl");
	...
	public void testEquality21() {
		CommandLine cl = new CommandLine();
		flags.add(testCasesPath+"Equal/TestEquality21.owl");
	...
	public void testEquality22() {
		CommandLine cl = new CommandLine();
		flags.add(testCasesPath+"Equal/TestEquality22.owl");
		boolean result = false;
		try {
			cl.main(flags.toArray(new String[flagsCount+1]));
		}catch (InconsistentOntologyException e) {
	...
	public void testEquality23() {
		CommandLine cl = new CommandLine();
		flags.add(testCasesPath+"Equal/TestEquality23.owl");
		boolean result = false;
		try {
			cl.main(flags.toArray(new String[flagsCount+1]));
		}catch (InconsistentOntologyException e) {
	...
	public void testDifference1() {
		CommandLine cl = new CommandLine();
		flags.add(testCasesPath+"closerule/TestDifference1.owl");
	...
	public void testEquality9() {
		CommandLine cl = new CommandLine();
		flags.add(testCasesPath+"closerule/TestEquality9.owl");
		boolean result = false;
		try {
			cl.main(flags.toArray(new String[flagsCount+1]));
		}catch (InconsistentOntologyException e) {
